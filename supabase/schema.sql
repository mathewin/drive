-- =============================================================
-- DriveWin — Schema Supabase (PostgreSQL)
-- Executar no SQL Editor do Supabase
-- =============================================================

-- ---------- USUÁRIOS / PERFIS ----------
-- Perfil ligado ao auth.users do Supabase. Papéis: admin, colaborador, motorista
...
-- ---------- FILA DE PAGAMENTO ----------
create table if not exists public.fila_pagamento (
  id uuid primary key default gen_random_uuid(),
...
-- ---------- RANKING REGIÃO ----------
create table if not exists public.ranking_regiao (
  id uuid primary key default gen_random_uuid(),
  nome text not null,
  tropa text,
  valor numeric(12,2) not null default 0
...
-- ASSINANTES: equipe lê/escreve; motorista vê o próprio nome (p/ checagem de acesso)
...
-- Seed: financeiro inicial + usuário admin
